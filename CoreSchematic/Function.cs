...
namespace CoreSchematic
{
	...
	public sealed class Function
	{
		...
		private Function(ComponentInstance instance, Function unbound)
		{
			this.Unbound = unbound ?? throw new ArgumentNullException(nameof(unbound));
		...
		public Function MakeInstance(ComponentInstance instance)
		{
			...
			return new Function(instance, this);
		}
		...
		/// <summary>
		/// Gets the unbound function for this instance function.
		/// </summary>
		/// <value>The unbound.</value>
		public Function Unbound { get; }
